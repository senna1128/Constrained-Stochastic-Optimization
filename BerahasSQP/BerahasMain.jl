        ...
        while i <= LenCStep
            ...
            while j <= LenVarSigma
                ...
                while rep <= TotalRep
                    ...
                    X, Lam, KKT, Time, IdCon, IdSing = BerahasSQP(nlp,StepCSet[i],VarSigma[j],Max_Iter,EPS,tau,epsilon,sigma,xi,theta,1)
                    if IdSing == 1
                        break
                    elseif IdCon == 0
                        rep += 1
        ...
        while i <= LenDStep
            ...
            while j <= LenVarSigma
                ...
                while rep <= TotalRep
                    ...
                    X, Lam, KKT, Time, IdCon, IdSing = BerahasSQP(nlp,StepDSet[i],VarSigma[j],Max_Iter,EPS,tau,epsilon,sigma,xi,theta,0)
                    if IdSing == 1
                        break
                    elseif IdCon == 0
                        rep += 1
