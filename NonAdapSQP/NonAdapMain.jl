        ...
        while i <= LenCStep
            ...
            while j <= LenSigma
                ...
                while rep <= TotalRep
                    ...
                    X, Lam, KKT, Time, IdCon, IdSing = NonAdapSQP(nlp, StepCSet[i], Sigma[j], Max_Iter, EPS, 1)
                    if IdSing == 1
                        break
                    elseif IdCon == 0
                        rep += 1
        ...
        while i <= LenDStep
            ...
            while j <= LenSigma
                ...
                while rep <= TotalRep
                    ...
                    X, Lam, KKT, Time, IdCon, IdSing = NonAdapSQP(nlp, StepDSet[i], Sigma[j], Max_Iter, EPS, 0)
                    if IdSing == 1
                        break
                    elseif IdCon == 0
                        rep += 1
